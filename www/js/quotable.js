...
function saveImage() {
    ...
    html2canvas($poster, {
        ...
        onrendered: function(canvas) {
            ...
            var a = $("<a>")
                .attr("href", strDataURI)
                .attr("download", "quote-" + filename + ".png")
                .appendTo("body");
...
$(function() {
    ...
    $themeButtons.on("click", function() {
        ...
        $poster
            .removeClass(
                "poster-theme1 poster-theme2 poster-theme3 poster-theme4 poster-theme5 poster-theme6 poster-theme7 poster-theme8 poster-theme9"
            )
    ...
    $aspectRatioButtons.on("click", function() {
        ...
        $(this).addClass("active");
        $poster
            .removeClass("square sixteen-by-nine facebook-ratio two-by-one")
            .addClass($(this).attr("id"));

        if (
            $poster.hasClass("sixteen-by-nine") ||
            $poster.hasClass("facebook-ratio") ||
            $poster.hasClass("two-by-one")
        ) {
            adjustFontSize(32);
            $fontSize.val(32);
        } else {
